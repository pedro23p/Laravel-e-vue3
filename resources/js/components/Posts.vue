    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between pb-2 mb-2">
                ...
                <div>
                    <button class="btn btn-success" type="button" @click="this.$router.push('/posts/add')">Nova pessoa</button>
                </div>
            </div>
                ...
                <tbody>
                    <tr v-for="(post, index) in posts" :key="post.id">
                        ...
                        <td class="text-center">
                            <router-link :to="{name:'editpost', params: {id:post.id}}" class="btn btn-warning">Editar</router-link>
